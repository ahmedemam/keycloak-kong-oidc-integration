...
![Request Flow](./../keycloak-kong-oidc/images/request-flow.png)
...
![Keycloak Login](./../../keycloak-kong-oidc/images/keycloak-login.png)
...
![Keycloak add Realm](./../keycloak-kong-oidc/images/keycloak-add-realm.png)
...
![Keycloak New Realm](./../keycloak-kong-oidc/images/keycloak-new-realm.png)

Once saved, you'll be redirected to the realm settings page:

![Keycloak realm settings](./../keycloak-kong-oidc/images/keycloak-realm-settings-1.png)
...
![Keycloak create client](./../keycloak-kong-oidc/images/keycloak-create-client-1.png)

Fill in the "Client ID" field with then "kong" string then save.

![Keycloak client settings](./../keycloak-kong-oidc/images/keycloak-client-settings-1.png)
...
![Keycloak client settings](./../keycloak-kong-oidc/images/keycloak-client-settings-2.png)

Now, create a second client, named "myapp".

![Keycloak Create Client 2](./../keycloak-kong-oidc/images/keycloak-create-client-2.png)
...
![Create User](./../keycloak-kong-oidc/images/keycloak-create-user-1.png)
...
![Change Password](./../keycloak-kong-oidc/images/keycloak-user-change-password.png)
...
![Terminal IP](./../keycloak-kong-oidc/images/terminal-ip.png)
...
CLIENT_SECRET="282c1a54-6ca5-41b3-9467-43fa3d3b7127"
```
...
![Konga Kong Plugins OIDC](./../keycloak-kong-oidc/images/konga-plugins-oidc.png)
...
echo $RAWTKN
{
  "access_token": "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJENkhLTHlubllGVkEtNGZKLWFLR3o1ai0xMHNFQ2NBZTA1UUp0Y05xdEN3In0. .i0S_8Bf9TfVbHHTIVTIMM-q4K65jLhzuXnRfUvXdCti0LfxjEl_vrj9dzsigUhi-C5JKRGyZYi3ZZn6rlpgWD0uzVDcl6jMnpFW4lrJukrKHGUVd6_VYLPkdRFnylmsYfuvMT2DdHBVhpFOzhnr1zP9cGGdFozUzd90Drj_P6l1wjWg47Jwgo5WsJCnr1jzcPY784Ao2Lz2jFZwiBSqWW1Hwj2uSZRXRvjjPd0_LUhGqSi5LFjTFni3eTLXPBwrjSZq_JBlk1hMEoMfp7JKnB5tF4poGSO2tRTd-3j80BlY6jwAyTDWDDw0-fdp_UrhW_10VaxPXNyHc0AgGXDkvDA",
  "expires_in": 300,
